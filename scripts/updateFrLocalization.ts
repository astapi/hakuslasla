 ...
 * フランス語ローカライゼーション更新
 *
 * npx tsx --tsconfig tsconfig.scripts.json scripts/updateFrLocalization.ts
 */
...
const NEW_NAME = 'Loot Dive: Hack&Slash Donjon';
const NEW_SUBTITLE = 'Idle Looter RPG × Build Craft';
const NEW_KEYWORDS =
  'Roguelike,Butin,Combat,Infini,Hors ligne,Trésor,Boss,Aventure,Fantaisie,Armes,Solo,Auto,Passif,Skill';
