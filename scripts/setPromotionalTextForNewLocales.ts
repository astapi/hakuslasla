/**
 * 新しく追加した言語にプロモーションテキストを設定
 *
 * 使用例:
 * npx tsx --tsconfig tsconfig.scripts.json scripts/setPromotionalTextForNewLocales.ts
 */
...
// 英語原文:
// "Dive into dungeons and hunt legendary loot. Fully automated battles for busy players. Explore 17+ dungeons, defeat bosses, and craft your ultimate build."

// 各言語のプロモーションテキスト（英語から翻訳）
const promotionalTexts: Record<string, string> = {
  // 簡体字中国語
  'zh-Hans':
    '深入地下城，狩猎传说装备！全自动战斗，适合忙碌的玩家。探索17+地下城，击败Boss，打造你的终极Build！',

  // 繁体字中国語
  'zh-Hant':
    '深入地下城，狩獵傳說裝備！全自動戰鬥，適合忙碌的玩家。探索17+地下城，擊敗Boss，打造你的終極Build！',

  // 韓国語
  ko: '던전에 뛰어들어 전설 장비를 사냥하세요! 바쁜 플레이어를 위한 완전 자동 전투. 17개 이상의 던전 탐험, 보스 격파, 궁극의 빌드 구축!',

  // スペイン語 (Spain)
  'es-ES':
    '¡Sumérgete en mazmorras y caza botín legendario! Batallas totalmente automáticas para jugadores ocupados. Explora más de 17 mazmorras, derrota jefes y crea tu build definitivo.',
  ...
  // フランス語
  'fr-FR':
    'Plongez dans les donjons et chassez du butin légendaire ! Combats entièrement automatiques pour les joueurs occupés. Explorez plus de 17 donjons, battez des boss et créez votre build ultime.',

  // ドイツ語
  'de-DE':
    'Tauche in Dungeons ein und jage legendäre Beute! Vollautomatische Kämpfe für beschäftigte Spieler. Erkunde über 17 Dungeons, besiege Bosse und erstelle deinen ultimativen Build.',
};

async function main() {
  console.log('🌐 新しい言語にプロモーションテキストを設定\n');
