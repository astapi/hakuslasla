 ...
 * ドイツ語ローカライゼーション更新
 *
 * npx tsx --tsconfig tsconfig.scripts.json scripts/updateDeLocalization.ts
 */
...
const NEW_KEYWORDS =
  'Roguelike,Beute,Kampf,Verlies,Endlos,Offline,Schatz,Boss,Skilltree,Sammeln,Fantasie,Abenteuer,Waffen';
